...
<body>
    <div class="grid-container">
                ...
                <form method="POST">
                    ...
                    <div class="modal-title" style="background-color:var(--black); color:white;">
                        ...
                        <div class="title-buttons">
                            <button type="submit" class="submit" style="background-color:var(--green); color:white;">Accept</button>
                            <button type="button" class="filterOpen" data-target="reject-refund" onclick="document.getElementById('new-refund').classList.toggle('hidden')" style="background-color:var(--red); color:white;">Reject</button>
        ...
        <div class="modal-wrapper hidden" id="reject-refund">
            <div class="modal">
                <form method="POST">
                    <!-- The title of the modal goes here -->
                    <div class="modal-title" style="background-color:var(--black); color:white;">
                        ...
                        <div class="title-buttons">
                            <button type="submit" class="submit" style="background-color:var(--green); color:white;">Submit</button>
                            <button type="button" class="filterOpen" data-target="reject-refund" style="background-color:var(--light-grey); color:black;">Close</button>
                        </div>
                    </div>
                    <!-- The title of the modal ends here -->
                    ...
                    <div class="modal-contents">
                        ...
                        <div class="inputs">
                            <label for="trucks-service">Rejection Reason</label>
                            <input type="text" placeholder="Rejection Reason Description Here">
                        </div>
                    </div>
                </form>
            </div>
        ...
        <main class="main-container">
            <div class="page-title">
                <h1>NEW REFUND REQUESTS</h1>
                <div class="quick-link">
                    <p><a href="index.php"> HOME </a> > NEW REFUNDS</p>
                </div>
            </div>
            <div class="main-content">
                <div class="table-desc">
                    <h3>PENDING REFUNDS LIST</h3>
                </div>
                <hr>
