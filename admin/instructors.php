                ...
                <div class="table-desc">
                    <div class="table-desc">
                        <div class="main-title-button">
                            ...
                            <a href="create-instructor.php"><button type="button" style="background-color:var(--yellow); position:relative; right:0; padding:0.5rem 1rem 0.5rem 1rem;">+ADD INSTRUCTOR</button></a>
                        </div>
                    </div>
                </div>
                <hr>
                        ...
                        <tbody>
                            <?php for ($i = 1; $i <= 30; $i++) { ?>
                                <tr>
                                    ...
                                    <td>09123456789</td>
                                    <td><a href="instructor-page.php"><button type="button"><i class="fa fa-eye" aria-hidden="true"></i></a></button><button type="button"><i class="fa fa-trash" aria-hidden="true"></i></button></td>
                                </tr>
                            <?php } ?>
                    </table>
                </div>
