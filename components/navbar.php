...
<nav class="navbar desktop">
    <div class="navigation-left">
        ...
        <ul class="nav-links">
            ...
            <li <?php echo ($url && $url === 'explore-exercises.php' || $url === 'all-exercises.php' || $url === 'view-exercise.php') ? 'class="active"' : ''; ?>><a href="explore-exercises.php">EXERCISES</a></li>
            <li <?php echo ($url && $url === 'explore-instructors.php' || $url === 'profile-instructor.php') ? 'class="active"' : ''; ?>><a href="explore-instructors.php">INSTRUCTORS</a></li>
    ...
    <?php if ($isLoggedIn): ?>
        <div class="user-profile">
            ...
            <div class="filters shadow hidden" id="user-dropdown">
                <p style="  word-wrap: break-word; overflow-wrap: break-word; max-width: 100%; ">
                    <?php
...
<ul class="nav-links-mobile">
    ...
    <a href="explore-exercises.php">
        <li <?php echo ($url && $url === 'explore-exercises.php' || $url === 'all-exercises.php' || $url === 'view-exercise.php') ? 'class="active"' : ''; ?>>EXERCISES</li>
    </a>
