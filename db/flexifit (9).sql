...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 11, 2025 at 07:57 AM
...
(18, 'abcd', 'ic.christian.gutierrez@cvsu.edu.ph', '$2y$10$e5Ga9lzxyq9u4GuQPUyWZOU7wyGtMCfCcoYvnJ25P2QWACG0UWtxy', 'Christian', 'Gutierrez', '1111-11-11', 9166945580, 'male', 'default.jpg', '2025-06-11 12:19:50', '2025-06-11', '2025-06-11', 'user', 'active', NULL, NULL);
...
CREATE TABLE `workout_history` (
  ...
  `userID` int(11) NOT NULL,
  `workoutID` int(11) NOT NULL,
  `finshedAt` date NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `workout_history` (`ID`, `userID`, `workoutID`, `finshedAt`) VALUES
(1, 1, 15, '2025-06-11'),
(2, 18, 15, '2025-06-11');
