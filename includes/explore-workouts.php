...
function get_search_workouts($conn, $workoutName)
{
    $searchTerm = "%" . strtolower($workoutName) . "%";
    $stmt = $conn->prepare("SELECT `workout`.`ID`, `workout`.`workoutName`, `workout`.`workoutPicUrl`, `workout`.`workoutDescription`, `workout`.`difficulty`,
